...
export const TABLE_SPEC = {
  recorridos: {
    rank: 1,
    columns: { uuid: 'uuid', name: 'text', description: 'text', ...META },
  },
  audios: {
    rank: 2,
    columns: {
  ...
  obras: {
    rank: 4,
    columns: {
      uuid: 'uuid', name: 'text', owner_id: 'uuid', recorrido_uuid: 'uuid', visibility: 'text',
      share_token: 'text', cover_lat: 'float', cover_lon: 'float', cover_min_lat: 'float',
      cover_max_lat: 'float', cover_min_lon: 'float', cover_max_lon: 'float', ...META,
    },
  },
  obra_artistas: {
    rank: 5,
...
export const REQUIRED = {
  recorridos: ['uuid', 'name', 'logical_version', 'updated_at'],
